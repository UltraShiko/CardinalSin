label Explanation:
    ...
    extend " His hair is disheveled, his jagged fingernails are unsightly, and he's wearing short sleeves 
    despite the winter's snow."
    "Worst of all, he's a Malconvoker - a buffoon who summons devils to fight other devils. It's only a matter of time 
    before one takes his head off."
    "Granted, I'm no saint myself. We only avoid execution because we Emissaries hunt down the trash the Celestials don't 
    wish to deal with."
    ...
    extend " For example, Caius rarely makes eye contact without straining himself. And one of his 
    limbs, and sometimes his entire body, is always in motion."
    "It was humorous watching him weave past Persephone's attacks. I figured he had an unusual fighting
    style."
    ...
    from one's regrets, much like your Malice comes from hatred. "

    "I see. Jory told me the monk lost control when he learned what happened to his hometown. Most notably, 
    the fate of some old companion of his."
    "Considering the regrets I have, I wonder why that white mana hasn't sprouted from me yet. Guess I'm not 
    pure enough."
    ...
    "He hands me a writ. It's a warrant written by the Celestials to search some house, under suspicion of the occupant 
    harboring Sanguine Paste."
    "My fingers tense upon reading those wretched words. That infernal drug causes nothing but problems, and people 
    {i}still{/i} use it!"
    ...
    "When I first met this loon, he had a brute of a fiend bound to his service. She was over seven feet tall and 
    a even monster by devil standards."
    ...
    extend " However, I have no leads. And Thrycia, or what remains of it, is a week's journey away. 
    Even if I do find the pain devil there, it'd be curtains for me."
    "As much as I'm loath to admit it, these paste dealers are the safer target right now. And 
    I detest them with a burning passion."
    "When overused, Sanguine Paste warps your humanity. It makes you crave forbidden pleasures 
    until you ultimately turn to seeking the blood of others."
    "These drug dealers may as well be plaguespreaders. They won't threaten all of humanity, 
