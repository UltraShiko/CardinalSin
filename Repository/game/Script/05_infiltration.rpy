label Infiltration:
    ...
    "The hallucinations vary based on our desires. I thought I could fly out of this god forsaken empire. My hardships were caused by {i}the Recknoning's{/i} impact."
    extend " Thanks to that archfiend, all I knew was poverty and sadness. Sanguine Paste gave me everything I ever wanted, and took everything else..."
    ...
    extend " The place is bereft of homely items such as furniture. Instead, it's filled to the brim with trash such as empty bottles, cigarette butts, and general junk."
    "I expect rats and vermin to scurry across my boot with each step I take. I see a hallway leading back to what I guess is a bedroom, barricaded by more trash."
    ...
    "How has this place not been searched sooner? Even if the Celestials have their hands full, where are the city guards?"
    extend " Hmm, I wonder how many of them are in this circle? Or have been bribed? Mortals are weak in the face of sinful temptation, after all..."
    ...
    ch "Yes, yes, buy a lot more than my average customer, I'm assuming. Hehehehe, to whom do I owe the pleasure for his patronage."
    ...
    extend " His entire body is lanky, emaciated, yet also agile. His long fingers tenderly toy with their spoils, each equipped with grisly nails at their tips. Whatever he is, we're not the same."
    ...
    "If I use, I will hallucinate but won't be incapacitated. My cravings have evolved to blood, and paste is now only a recreation rather than a hindurance."
    ...
    extend " I see. With enough effort, I'm able to morph these illusions into whatever I fancy. If I wished, I could use this substance to its fullest."
    ...
    extend " My muscles brace. He is {b}MINE!{/b} His feeble matron can't save him, even if she was here!"
    ...
    "I understand now. Christoph is the only prey I've ever spared. As I sank my fangs into him that day, I realized just how low I had sunk."
    ...
    extend " My sin is irredeemable. Only Hell or oblivion await me in the afterlife. I have no regrets. Tis a fitting end for someone like me."
    ...
    extend " I grab my hatchet, my resolve somewhat restored. It's not an intent to save her that drives me. She put herself in this position, after all."
