...
label confrontation:
    ...
    extend " However I'm feeling rather merciful tonight. So if you abandon your wares and flee, you just might see the sun tomorrow."
    ...
    "The tension between us spikes. I have never been the best at diplomacy. It may have been wiser to reveal our connection after he left..."
    extend " Of course, I would've much preferred my \"typical\" approach. Maybe I should've brought that goody-goody Caius with me..." 
    ...
    extend " The rest of his clients do so as well, albeit more out of disinterest. They seem more disappointed than afraid. Typical addicts..."
    ...
    ch "Not only did you kill my mother, you murdered my humanity! After you \"spared\" me, I started getting these cravings..."
    extend " At first, I wanted raw meat. My caretakers thought I was mad, so I had to steal it." 
    ch "It was {b}scrumptuous!{/b}! But not enough... My tastes devolved... I broke out of the orphanage and sought out the most {b}forbidden{/b} pleasures. From whores, to drugs, and finally..."
    ...
    ch "Of course you can't... You are gifted. You can feast on blood and lead a normal life. While I, the boy you defiled,, has to suffer a {b}neverending hunger!!!{/b}"
    ...
    extend " So long as you pay, you keep both the paste and your life. Theft is punished severely by the Celestials, so becoming my meal is {b}JUSTICE!{/b} They knew the rules!"
    ...
    extend " I have to admit, I'm impressed with your ruse. Butchers are outcasts by trade, but few would suspect one of cannibalism."
    ...
    "At times like these, I'm thankful I've lost my mortality. If I let my guilt speak for me, I'd just become another meal."
    extend " Cruel indeed considering , and the only way to save him is to expose his weakness."
    ...
    "A red aura begins seeping from him. Damn, he's wielding Malice. And here I thought I destroyed his resolve..."
    ...
    ch "Ahhh, I see."
    extend " They say you need hatred to wield Malice. I'm not surprised that you cling to it. You are a leech, after all. And that's too bad."
    ...
    extend " My breathing is rapid and labored. Vampires don't have the same vulnerabilities as mortals, so we don't die from internal injuries. That fact is the only reason I'm standing..."
    "My speed is shot. Between my punctured leg and chest, I can't flurry anymore. If he goes on another onslaught..."
    ...
    extend " He's hunched over, breathing almost as if he's drowning. The red coating around his claws has shrunk too."
    "It appears that we both are nearing our limit. However, I'm sure he still has enough mana to kill me despite how tired he is."
    ...
    extend " No one will mourn me. No one {i}should{/i} mourn me. Not even Caius. Perhaps my death will rid him of his silly fantasy of joining us. A soul as pure as his does not belong here."
    "Christoph's maw inches wider and wider with each step he takes. Yet my mind only thinks on that monk."
    ...
    extend " Despite my injuries, my fist have jolted forward and slammed into his mouth, dislocating his jaw. Despite my injuries, my fist jolts and slammed his mouth shut."
    ...
    extend " It's not as potent as Malice, however it isn't nearly as taxing. I don't feel as drained as I would otherwise."
    "It pushes me forward. It grants me the strength to overcome my pain and keep fighting. Perhaps my desire is to save him? Heh, how trite."
    ...
    extend " I hold my hatchet towards my hand. I know my blood can fuel Malice, but will the same be true for Sin?"
    ...
    extend " That attack is a feint, the blood pushing my body to accelerate. It looks to most as if I've teleported."
    ...
    gr "As I said, you are simple. You didn't realize the toll you were placing on your body. Even without summoning mana, you use up your very vitality when wielding your blood."
    ...
    gr "Unfortunately Christoph, my powers were limited during this fight. I couldn't wield mana nor kill you."
    
    ch "Stop lying..!"

    gr "What do I gain by lying to you now? Torment? Please..."
    extend " As I said earlier, your name saved those Celestials. And Malice requires hatred. Can you see why I couldn't wield it?"
    gr "I needed to adapt a different mana to defeat you. You may be surprised to know that I wanted to save you."
    
    ch "S-Save me?! Unless you can fix what I am, you can't save me!"
    
    gr "On that, we agree. However I will not kill you either. The only person who can save you is yourself."
    ...
    extend " But as I glance toward the goblin, I disocver he's not there anymore. Wonder how he escaped..."
