...
label confrontation:
    ...
    "Of course, I would've much preferred my \"typical\" approach.\nMaybe I should've brought that goody-goody Caius with me..." 
    ...
    ch "It was {b}scrumptuous!{/b}! But not enough... My tastes devolved... I broke out of the orphanage and sought out the most {b}forbidden{/b} pleasures.\nFrom whores, to drugs, and finally..."
    ...
    extend "\n{b}SO I DEVOURED HIM AS WELL!!!{/b}" with vpunch

    "He's becoming more and more unstable as we talk.\nI'm going to have to use force."
    "I reach for my sword. I only intend to draw it if he attacks."
    extend "\nI have a feeling he seeks to devour me next. It would be a fitting punishment."
    ...
    ch "{b}YOU SAID YOU NEARLY DEVOURED FOUR MEN!\nWERE THEY MONSTERS TOO?!{/b}" with vpunch
    ...
    extend "\nI cough up blood. He grins maniacally and licks it away."
    ...
    extend " He's hunched over, breathing almost as if he's drowning.\nThe red coating around his claws has shrunk too."
    ...
    "No one will mourn me. No one {i}should{/i} mourn me. Not even Caius.\nPerhaps my death will rid him of his silly fantasy of joining us.\nA soul as pure as his does not belong here."
    "Christoph's maw inches wider and wider with each step he takes.\nYet my mind only thinks on that monk."
    ...
    extend "\nIt's not as potent as Malice, however it isn't nearly as taxing. I don't feel as drained as I would otherwise."
    ...
    extend "\nAs I said earlier, your name saved those Celestials. And Malice requires hatred. Can you see why I couldn't wield it?"
