label Revelation:
    ...
    "Caius recoils as a wooden mug, filled to the brim with blood's metallic stench, is placed 
    before me."
    extend " I down it all immediately. The pain in my body eases to a dull tingle instead of an 
    agonizing throb. I feel as if I'm drunk as both fatigue and drowsiness finally sett in."
    ...
    "I then take notice of the mask shrouding Caius's forehead. It looks like its glued to his 
    skin."
    ...
    extend " He now has a trump card. The inhibitors will vanish if he rips it off. You might want to flee the 
    scene when that happen~."
    ...
    gr "Stop shouting. Nick summons devils to fight devils. I'm truly disappointed that you 
    ...
    extend " Whenever he's done something foolish, he acts like this. A sane mortal would dread my
    wrath, but Nick's lust for pain encourages it."
    ...
    bu "Oooh yes, city destroyed! Burned! Blood and ash everywhere! Many dead knights, with red
    and brown armors scattered about! It was hilarious! Favorite mission so far~!"
    gr "Hmm, so those hellknights perpetuated that..."
    ni "Yep... They lacked the numbers to face the Celestials, so they sacked Thrycia. I guess 
    they believed their attack wouldn't warrant retaliation since that city is independent."
    gr "I do not understand why we cling to this peace. It's only a matter of time before those
    peons attack again."
    b "Unlikely! All of them are dead hahahaha!"
    ca "W-wait, you were there at Thrycia?!"

    "Caius eagerly passes me the staff. His eyes are filled with desperation, hoping that his 
    friend was not responsible, I imagine."
    "The imp eyes him like a slab of meat. I guess devils big and small can't resist corrupting souls
    as virtuous as his."
    ...
    bu "Nope~. Buzz said everyone dead. However...Buzz found a charred silhouette on the ground~. 
    Only devils could broil the earth like that. We explode when slain."
    ...
    bu "Buzz know mana signature of the deceased. Yes yes, the hellknights were not alone. In fact, some corpses
    were nice and crispy~. Electrocuted, hmhmhm!"
    bu "Buzz detect powerful mana. Very malicious and sadistic. We devils enjoy torturing others, but this one's
    bloodlust is unrivaled."
    play sound Lightgrapple
    ...
    play sound bam
    queue sound bam
    extend " Buzz darts to the ceiling and Caius watches, horrified, as I proceed to kick the
    shit out of Nick."
    "Small giggles escape him each time my boot bludgeons his chest. I'm almost happy he's enjoying 
    it, because I don't need to worry about breaking him."
    ...
    "Ishmael knows what godforsaken expression is on Nick's face. I never understood Caius's fixation
    on joining us."
    ...
    extend " Well, you can thank this maniac for that!. Yes, the leader of us Emissaries is an 
    irresponsible lunatic who summons devils! He is who you'll be working for."
    gr "That pain devil that destroyed Thrycia was {i]his{/i} doing! He could've sent it back too,
    but his vendetta kept her on our plane. And now she's loose..."
    ca "...If you understood how destructive this monster could be, why would you bind her?"
    ni "Ehehehe, but she's useful."
    gr "Worst of all, she's going to want revenge, and you and I will be the ones to hunt
    her down! If you thought Persephone was bad, oh Ishmael... You are not prepared!"
    ...
    extend " As dumbfounded as he seems, I'm impressed with how quickly he regains his composure. 
    Especially considering how he just lost his hometown because of an idiot."
    "Granted, Caius has a level head despite being so green. He only loses himself when his past 
    is brought up, a weakness the banshee exploited..."
    
    ca "...You summon fiends, does that mean you know how to defeat them?"
    ni "Of course. It's my passion. A really bad passion hehehe, but I know just about everything when it comes
    to devils."
    gr "He's only escaped the noose because he's useful. Even the Third had to put up with him."
    ca "Tell me Nick, can you track down my friend. If you can bind devils, perhaps you can seek out a
    dretchling?"
    gr "You don't need this fool's aid. Consult the Reverend."
    ca "But fiends are drawn to dretchlings like moths to a flame. Maybe this pain devil was 
    after him. Or maybe something else was.."
    ...
    "He'll be a liability, at this rate. All some monster has to do is capture his friend, and 
    Caius will surrender."
    extend " Besides, we Emissaries are not saviors."

    gr "Monk, heed my words."
    extend " If you think I'm about to partake in some rescue mission, do us both a favor and 
    abandon all hopes of joining us."
    ca "...I know it might be foolish of me. However, Nick has no trace on Persephone's whereabouts. 
    So I wonder if she might be involved somehow?"
    ...
    extend " Frankly, I plan on going to Thrycia with or without you. It was what I wanted to do
    before, you know..."
    ...
    ca "That, and I believe that the Celestials aren't addressing the root of our problems. I'd much rather cleanse
    the source, even if I have to get my hands dirty..."
    ...
    extend " But understand this. We will do things {i}my{/i} way. I'm not interested in rescuing damsels, or your
    friend."
    ...
    gr "Start trying to get that mana of yours under control. If you're truly able to wield Justice, we'll need that
    firepower."
    extend " More importantly, I don't want to have to protect you from yourself. I expect you to make the 
    most of your respite."
    ...
    "My mind races. I still can't believe that I channeled Sin in place of Malice. 
    Does this development imply I'm getting soft? I sure hope not..."
    "I clench my fists, still irate at what Jory said."
    extend " That \"kindness\" nearly cost me my life. Am I to be food for monsters because I'm sentimental now? I'd
    sooner die!"
    "Besides, I'm going to have to keep that monk from getting himself killed. It isn't a matter of when 
    our enemy exploits his piety, but {i}when{/i}."
    extend " If anything, I need to toughen up on the-"

    vi "Hey Snowflake! We need to chat." with vpunch

    "A voice booms into my ear. No one else has arrived here, or Caius and Nick would've reacted by now. 
    And our base is littered with alarm wards. So it must be telepathy."
    extend " That, and only one person addresses me with that name..."

    gri "Banshee. To what do I owe the displeasure?"
    pei "So I did some digging, and you're a liar. You weren't jinxed, you fed on a child... 
    You turned him into a freak, {i}after{/i}, you devoured his mother in front of him!"
    gri "Heh, do my ears betray me, or does {i}the banshee{/i} have a bleeding heart?"
    gri "The fact that you fell for such a fib betrays your ignorance. Perhaps you aren't
    as clever as I thought."
    pei "Yeah well here's something to chew on. If I see you again, it's on sight!"
    extend " And here I was pitying you, willing to take you under my wing. You're disgusting, 
    and that's coming from me..."
    gri "Oh no, the Banshee doesn't approve of me. I'm certain to lose so much sleep."
    extend " Especially when you and your broodmother's henchman murdered thousands. People
    still suffer because {i}the Reckoning{/i}. And you don't scare me, heh, it's quite the opposite."
    gri "If you're so offended, then stop hiding. We'll find you eventually."
    pei "In due time, Snowflake. Your days are numbered all the same. You'll beg for death when Mother gets her
    hands on you."
    ...
    extend " I gather a streak of the blood on my finger and lick it, treating myself to the 
    sight of a monstrous grin."
