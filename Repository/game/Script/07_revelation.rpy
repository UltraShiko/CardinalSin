label revelation:
    ...
    gr angry "Take your hand off of me. These wounds aren't fatal."
    ...
    gr angry "Stop shouting!" with vpunch
    ...
    show buzz at buzz_normal_range with dissolve:
        flip
        left
    ...
    gr angry "{size=+80}{b}GOOD!{/b}{/size}" with vpunch #center text via textbox
    ...
    gr angry "Thrycia was your home, right? Remember how your friend was blamed for its destruction?"
    extend "\nWell, you can thank this maniac for that!" with vpunch
    gr angry "Yes, the leader of us Emissaries is an irresponsible lunatic who summons devils! He is who you'll be working under."
    extend "\nThat pain devil that destroyed Thrycia was {i}his{/i} doing! He could've killed her, but now she's loose..."
    ...
    gr angry "Worst of all, she's going to want revenge, and you and I will be the ones to hunt her down!" 
    ...
    gr angry "{size=+80} Be quiet, swine!{/size}" with vpunch
    gr angry "If this tomfoolery teaches you anything, monk, let it be that you should leave."
    ...
    gr angry "He's only escaped the noose because he's useful!"
    ...
    gr angry "You don't need this fool's aid. Consult the Reverend."
    ...
    show buzz happy at buzz_normal_range with moveinleft:
        center
    ...
    gr angry "Do not fill his head with fantasies, Malconvoker! \nHe's barking up the wrong tree."
    ...
    show buzz at buzz_normal_range with moveintop:
        center
    ...
    gri smirk "Heh, do my ears betray me, or does {i}the banshee{/i} have a bleeding heart?"
    extend " The fact that you fell for such a fib betrays your ignorance.\nPerhaps you aren't as clever as I thought."
    ...
    gri smirk "Wonderful! That's just the way I wanted it, banshee!"
